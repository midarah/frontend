							...
							<h2 className="mb-2 text-white">
								...
								{hentai.mangaka && (
									<Link
										...
										className="bg-blue-800 hover:bg-blue-600 transition-all ease-in duration-200 border border-white px-3 rounded-xl mr-1">
										{hentai.mangaka}
									</Link>
								)}
							</h2>
								...
								{hentai.tags.map((tagEl, index) => {
									...
									return (
										<Link
											...
											className="bg-blue-800 hover:bg-blue-600 transition-all ease-in duration-200 border border-white px-3 rounded-xl mr-1 shadow-lg"
											key={index}>
											{tagEl}
										</Link>
									);
